...
class VehicleFilterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fuel_type' => 'nullable|string|in:petrol,diesel,electric,hybrid,lpg,cng,hydrogen,other',
            'transmission' => 'nullable|string|in:manual,automatic,semi-automatic',
            'body_type' => 'nullable|string|in:sedan,wagon,hatchback,suv,coupe,convertible,van,truck,other',
            ...
            'type' => 'nullable|string|in:car,motorcycle,truck,caravan,van,atv,trailer,construction,agricultural,forklift,bus',
            'features' => 'nullable',
            'vehicle_condition' => 'nullable',
            'drive_type' => 'nullable|string|in:fwd,rwd,awd,4wd',
            'emission_class' => 'nullable|string|in:euro1,euro2,euro3,euro4,euro5,euro6,euro6d',
